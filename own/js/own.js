...
var comfirmModify = function(tNoText){
    ...
    var url = '/updateTeacher?tName='+tNameText+'&tEducation='+ tEducationText+'&tTitle='+tTitleText+'&tSchool='+ tSchoolText+ '&tTime=' + tTimeText+'&tNo='+ tNoText;
    console.log(url);
    axios.post(url)
        .then(function (response) {
        console.log("@@@"+ tNameText);
...
addTeacherButton.onclick = function(){
    ...
    url = '/addTeacher?tNo='+tNo+'&tName='+tName+'&tEducation='+tEducation+'&tTitle='+tTiTle+'&tSchool='+tSchool+'&tTime='+tTime;
    console.log(url);
    axios.post(url)
    .then(function (res) {
        console.log(res);
